//===============================================
//
// Tierra Sol Luna Gravitaicional
// stdc++20
...
int main() {
  // Parametros
  const int Niter = 365 * 1000;            // numero de iteraciones
  const long double h_step = 3600 * 0.24L; // tamaño de paso
  const int out_cada = 50;                 // output cada out_cada iteraciones
