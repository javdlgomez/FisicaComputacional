...
#include <random>
//#include <<sstream>
// si no se tiene la version mas actualizada debe utilizarse esa libreria
...
// Parametros
#define n_iteraciones (365L * 5000)  // numero de iteraciones
#define h_step (3600.0L * 24L)       // tamaño de paso
#define medio_h_step (h_step * 0.5L) // tamaño de paso / 2
#define out_cada (6050)              // output cada out_cada iteraciones
